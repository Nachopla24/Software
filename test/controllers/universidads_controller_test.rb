...
class UniversidadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create universidad" do
    assert_difference('Universidad.count') do
      post universidads_url, params: { universidad: { descripcion: @universidad.descripcion, direccion: @universidad.direccion, nombre: @universidad.nombre, numDireccion: @universidad.numDireccion } }
    end
  ...
  test "should update universidad" do
    patch universidad_url(@universidad), params: { universidad: { descripcion: @universidad.descripcion, direccion: @universidad.direccion, nombre: @universidad.nombre, numDireccion: @universidad.numDireccion } }
