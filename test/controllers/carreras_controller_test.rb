...
class CarrerasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create carrera" do
    assert_difference('Carrera.count') do
      post carreras_url, params: { carrera: { codigo: @carrera.codigo, descripcion: @carrera.descripcion, nombre: @carrera.nombre } }
    end
  ...
  test "should update carrera" do
    patch carrera_url(@carrera), params: { carrera: { codigo: @carrera.codigo, descripcion: @carrera.descripcion, nombre: @carrera.nombre } }
